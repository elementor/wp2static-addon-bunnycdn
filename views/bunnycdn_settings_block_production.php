...
<section class="wp2static-content wp2static-flex">
  ...
  <div class="content">
    <?php $tpl->displayTextfield( $this, 'baseUrl-bunnycdnProduction', 'http://mystaticsite.com', '', '' ); ?>
...
<section class="wp2static-content wp2static-flex">
  ...
  <div class="content">
    <?php $tpl->displayTextfield( $this, 'bunnycdnStorageZoneNameProduction', 'Storage Zone Name', 'ie, mybunnystoragezone. This is where the files will be uploaded to. ' ); ?>
  </div>
</section>
...
<section class="wp2static-content wp2static-flex">
  ...
  <div class="content">
    <?php $tpl->displayTextfield( $this, 'bunnycdnStorageZoneAccessKeyProduction', 'Storage Zone Access Key', 'Find in your Storage Zone settings', 'password' ); ?>
  </div>
</section>
...
<section class="wp2static-content wp2static-flex">
  ...
  <div class="content">
    <?php $tpl->displayTextfield( $this, 'bunnycdnPullZoneIDProduction', 'Pull Zone ID', 'Numeric. ie, 1234. This will do a cache purge once all files are transferred', 'number' ); ?>
  </div>
</section>
...
<section class="wp2static-content wp2static-flex">
  ...
  <div class="content">
    <?php $tpl->displayTextfield( $this, 'bunnycdnPullZoneAccessKeyProduction', 'Pull Zone Access Key', 'Find in your Account settings', 'password' ); ?>
  </div>
</section>
...
<section class="wp2static-content wp2static-flex">
  ...
  <div class="content">
    <?php $tpl->displayTextfield( $this, 'bunnycdnRemotePathProduction', 'BunnyCDN Remote Path', 'will attempt to create folder recursively if non-existent' ); ?>
  </div>
</section>
